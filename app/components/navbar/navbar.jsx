...
import MenuSvg from "@/app/icons/menu";
import "./style.css";
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="sm:hidden flex items-center space-x-4">
              ...
              >
                <MenuSvg className="w-5 h-5 text-purple-600" />
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col">
              {menuItems.map(item => (
                <a
                  key={item}
                  href="#"
                  className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1"
                >
                  {item}
                </a>
              ))}
              <div className="flex justify-between items-center border-t-2 py-2">
                <a
                  href="#"
                  className="text-gray-800 text-md font-semibold border px-3 py-2 rounded-lg bg-purple-600 text-white"
                >
                  Start Listening
                </a>
              </div>
