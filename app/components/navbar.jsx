const Navbar = () => {
    return (
        <div className="bg-gray-100 font-sans w-full m-0">
            <div className="md:px-52 bg-white shadow">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between py-4">
                        ...
                        <div className="hidden sm:flex sm:items-center gap-[20px]">
                            <a href="#" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4">Pricing</a>
                            <a href="#" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4">About</a>
                            <a href="#" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4">Blog</a>
                        </div>

                        <div className="hidden sm:flex sm:items-center">
                            <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
                            <a href="#" className="text-gray-800 text-md font-semibold border px-4 py-3 rounded-lg bg-purple-600 text-white">Start Listening</a>
                        </div>
